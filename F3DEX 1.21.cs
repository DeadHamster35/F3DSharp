...
#define CALC_DXT_4b(width)	\
        ...
        */
        ...
        public byte[] gsSP1Triangle(uint[] VertIndexes)
        {
            ...
            binaryWriter.Write(BigEndian(
                BitConverter.GetBytes(F3DEX121_OpCodes.G_TRI1))
                );
        ...
        public byte[] gsSP2Triangles(uint[] VertIndexesA, uint[] VertIndexesB)
        {
            ...
            binaryWriter.Write(BigEndian(
                BitConverter.GetBytes(Convert.ToUInt32(F3DEX121_OpCodes.G_TRI2 | BitConverter.ToUInt32(BigEndian(gsSP1Triangle_w1(VertIndexesA)), 0)))
                ));
        ...
        public byte[] gsSPCullDisplayList(uint StartIndex, uint EndIndex)
        {
            ...
            binaryWriter.Write(BigEndian(
                BitConverter.GetBytes(Convert.ToUInt32(F3DEX121_OpCodes.G_CULLDL | (( StartIndex * 2 ) & 0xFFFF) ))
                ));
            binaryWriter.Write(BigEndian(
        ...
        public byte[] gsSPDisplayList(uint Address)
        {
            ...
            binaryWriter.Write(BigEndian(
                BitConverter.GetBytes(F3DEX121_OpCodes.G_DL)
                ));
        ...
        public byte[] gsSPEndDisplayList()
        {
            ...
            binaryWriter.Write(BigEndian(
                BitConverter.GetBytes(F3DEX121_OpCodes.G_ENDDL)
                ));
        ...
        {
            return gsDma1p(F3DEX121_OpCodes.G_VTX, Address, ((Count) << 10) | ((Count * 0x10) - 1), (Index * 2));
        }
        ...
        public byte[] gsDPSetTile(UInt32 Format, UInt32 Size, UInt32 Line, UInt32 TMem, UInt32 Tile, UInt32 Palette, UInt32 CMT, UInt32 MaskT, UInt32 ShiftT, UInt32 CMS, UInt32 MaskS, UInt32 ShiftS)
        {
            ...
            binaryWriter.Write(BigEndian(
                BitConverter.GetBytes(Convert.ToUInt32(F3DEX121_OpCodes.G_SETTILE | ((Format & 0x7) << 21) | ((Size & 0x3) << 19) | ((Line & 0x1FF) << 9) | (TMem & 0x1FF)))
                ));
        ...
        public byte[] gsSPTexture(UInt32 S, UInt32 T, UInt32 Level, UInt32 Tile, UInt32 OnFlag)
        {
            ...
            binaryWriter.Write(BigEndian(
                BitConverter.GetBytes(F3DEX121_OpCodes.G_TEXTURE | ((Level & 0x7) << 11) | ((Tile & 0x7) << 8) | (OnFlag & 0xFF))
                ));
            binaryWriter.Write(BigEndian(
        ...
        public byte[] gsDPLoadTLUTCmd(UInt32 Tile, UInt32 Count)
        {
            ...
            binaryWriter.Write(BigEndian(
                BitConverter.GetBytes(F3DEX121_OpCodes.G_LOADTLUT)
                ));
	...
	gsDPPipeSync()
        ...
        */
            ...
            public byte[] gsDPLoadTLUT_pal256(UInt32 Palette, UInt32 DRAM)
        {
            ...
            binaryWriter.Write(gsDPSetTextureImage(F3DEX121_Parameters.G_IM_FMT_RGBA, F3DEX121_Parameters.G_IM_SIZ_16b, 1, DRAM));
            binaryWriter.Write(gsDPTileSync());
            binaryWriter.Write(gsDPSetTile(0, 0, 0, 256, F3DEX121_OpCodes.G_TX_LOADTILE, 0, 0, 0, 0, 0, 0, 0));
            binaryWriter.Write(gsDPLoadSync());
            binaryWriter.Write(gsDPLoadTLUTCmd(F3DEX121_OpCodes.G_TX_LOADTILE, 255));
        ...
        public byte[] gsDPLoadTLUT_pal16(UInt32 Palette, UInt32 DRAM)
        {
            ...
            binaryWriter.Write(gsDPSetTextureImage(F3DEX121_Parameters.G_IM_FMT_RGBA, F3DEX121_Parameters.G_IM_SIZ_16b, 1, DRAM));
            binaryWriter.Write(gsDPTileSync());
            binaryWriter.Write(gsDPSetTile(0, 0, 0, (256 + (((Palette) & 0x0F) * 16)), F3DEX121_OpCodes.G_TX_LOADTILE, 0, 0, 0, 0, 0, 0, 0));
            binaryWriter.Write(gsDPLoadSync());
            binaryWriter.Write(gsDPLoadTLUTCmd(F3DEX121_OpCodes.G_TX_LOADTILE, 15));
            binaryWriter.Write(gsDPPipeSync());
        ...
        {
            return gsSPSetOtherMode(F3DEX121_OpCodes.G_SETOTHERMODE_H, Convert.ToUInt32(F3DEX121_Parameters.G_MDSFT_TEXTLUT), 2, Type);
        }
        ...
        public byte[] gsDPPipeSync()
        {
            ...
            binaryWriter.Write(BigEndian(
                    BitConverter.GetBytes(Convert.ToUInt32(F3DEX121_OpCodes.G_RDPPIPESYNC))
                ));
        ...
        {
            return gsSPSetOtherMode(F3DEX121_OpCodes.G_SETOTHERMODE_L, Convert.ToUInt32(F3DEX121_Parameters.G_MDSFT_RENDERMODE), 29, ModeA | ModeB);
        }
        ...
        public byte[] gsDPSetCombineLERP(UInt32[] GCCA, UInt32[] GCCB)
        {
            ...
            binaryWriter.Write(BigEndian(
                BitConverter.GetBytes(F3DEX121_OpCodes.G_SETCOMBINE | Convert.ToUInt32((GCCc0w0(GCCA[0], GCCA[2], GCCA[4], GCCA[6]) | GCCc1w0(GCCB[0], GCCB[2])) & 0xFFFFFF))
                ));
        ...
        public byte[] gsDPTileSync()
        {
            ...
            binaryWriter.Write(BigEndian(
                BitConverter.GetBytes(F3DEX121_OpCodes.G_RDPTILESYNC)
                ));
            binaryWriter.Write(0);
        ...
        public byte[] gsDPLoadSync()
        {
            ...
            binaryWriter.Write(BigEndian(
                BitConverter.GetBytes(F3DEX121_OpCodes.G_RDPLOADSYNC)
                ));
            binaryWriter.Write(0);
        ...
        public byte[] gsSPClearGeometryMode(UInt32 Mode)
        {
            ...
            binaryWriter.Write(BigEndian(
                BitConverter.GetBytes(Convert.ToUInt32(F3DEX121_OpCodes.G_CLEARGEOMETRYMODE))
                ));
            binaryWriter.Write(BigEndian(
        ...
        public byte[] gsSPSetGeometryMode(UInt32 Mode)
        {
            ...
            binaryWriter.Write(BigEndian(
                BitConverter.GetBytes(Convert.ToUInt32(F3DEX121_OpCodes.G_SETGEOMETRYMODE))
                ));
            binaryWriter.Write(BigEndian(
                BitConverter.GetBytes(Convert.ToUInt32(Mode))
                ));
        ...
        public byte[] gsDPLoadBlock(UInt32 Tile, UInt32 ULS, UInt32 ULT, UInt32 LRS, UInt32 DXT)
        {
            ...
            binaryWriter.Write(BigEndian(
                BitConverter.GetBytes(Convert.ToUInt32(F3DEX121_OpCodes.G_LOADBLOCK | ((ULS & 0xFFF) << 12) | (ULT & 0xFFF)))
                ));
        ...
        {
            return gsDPLoadTileGeneric(F3DEX121_OpCodes.G_SETTILESIZE, Tile, ULS, ULT, LRS, LRT);
        }
        ...
        {
            return gsSetImage(F3DEX121_OpCodes.G_SETCIMG, Format, Size, Width, Address);
        }
        public byte[] gsDPSetTextureImage(UInt32 Format, UInt32 Size, uint Width, UInt32 Address)
        {
            return gsSetImage(F3DEX121_OpCodes.G_SETTIMG, Format, Size, Width, Address);
        }
        ...
        public byte[] gsNinSetupTileDescription(UInt32 TextureFormat, UInt32 Size, uint Width, uint Height, uint TextureMemory, uint Tile, uint CS, uint MS, uint SS, uint CT, uint MT, uint ST)
        {
            ...
            binaryWriter.Write(
                gsDPSetTile(TextureFormat, Size, ((Width * F3DEX121_Parameters.G_IM_ArrayLineBytes[(int)Size]) + 7) >> 3, TextureMemory, Tile, 0, CT, MT, ST, CS, MS, SS)
            );

            binaryWriter.Write(
                gsDPSetTileSize(Tile, 0, 0, (Width - 1) << (int)F3DEX121_Parameters.G_TEXTURE_IMAGE_FRAC, (Height - 1) << (int)F3DEX121_Parameters.G_TEXTURE_IMAGE_FRAC)
            );
        ...
        public byte[] gsDPLoadTextureBlock(UInt32 TextureAddress, UInt32 TextureFormat, UInt32 Size, uint Width, uint Height, uint PaletteBanks, uint CS, uint MS, uint SS, uint CT, uint MT, uint ST)
        {
            ...
            binaryWriter.Write(gsDPSetTileSize(0, 0, 0,
                ((Width) - 1) << Convert.ToInt32(F3DEX121_Parameters.G_TEXTURE_IMAGE_FRAC),
                ((Height) - 1) << Convert.ToInt32(F3DEX121_Parameters.G_TEXTURE_IMAGE_FRAC)));
        ...
        public byte[] gsDPLoadTextureBlock_4b(UInt32 TextureAddress, UInt32 TextureFormat, uint Width, uint Height, uint PaletteBanks, uint CS, uint MS, uint SS, uint CT, uint MT, uint ST)
        {
            ...
            binaryWriter.Write(gsDPSetTextureImage(TextureFormat, F3DEX121_Parameters.G_IM_SIZ_16b, 1, TextureAddress));
            binaryWriter.Write(gsDPSetTile(TextureFormat, F3DEX121_Parameters.G_IM_SIZ_16b, 0, 0, 7, 0, CT, MT, ST, CS, MS, SS));
            binaryWriter.Write(gsDPLoadSync());
            binaryWriter.Write(gsDPLoadBlock(7, 0, 0, (((Width * Height) + 3) >> 2) - 1, CALCDXT_4b(Width)));
            binaryWriter.Write(gsDPPipeSync());
            binaryWriter.Write(gsDPSetTile(TextureFormat, F3DEX121_Parameters.G_IM_SIZ_4b, ((((Width) >> 1) + 7) >> 3), 
                0, F3DEX121_OpCodes.G_TX_RENDERTILE, PaletteBanks, CT, MT, ST, CS, MS, SS));
            binaryWriter.Write(gsDPSetTileSize(F3DEX121_OpCodes.G_TX_RENDERTILE, 0, 0,
                ((Width) - 1) << Convert.ToInt32(F3DEX121_Parameters.G_TEXTURE_IMAGE_FRAC),
                ((Height) - 1) << Convert.ToInt32(F3DEX121_Parameters.G_TEXTURE_IMAGE_FRAC)));
        ...
        {
            return gsDPLoadTileGeneric(F3DEX121_OpCodes.G_LOADTILE, Tile, ULS, ULT, LRS, LRT);
        }
        ...
        public byte[] gsDPLoadTextureTile_4b(UInt32 TextureAddress, UInt32 TextureFormat, UInt32 TWidth, UInt32 THeight, UInt32 ULS, UInt32 ULT, UInt32 LRS, UInt32 LRT, UInt32 PAL, UInt32 CMS, UInt32 CMT, UInt32 MaskS, UInt32 MaskT, UInt32 ShiftS, UInt32 ShiftT)
        {
            ...
            binaryWriter.Write(gsDPSetTextureImage(TextureFormat, F3DEX121_Parameters.G_IM_SIZ_8b, ((TWidth) >> 1), TextureAddress));

            binaryWriter.Write(gsDPSetTile(TextureFormat, F3DEX121_Parameters.G_IM_SIZ_8b,
                (((((LRS) - (ULS) + 1) >> 1) + 7) >> 3), 0, F3DEX121_OpCodes.G_TX_LOADTILE, 0, CMT, MaskT, ShiftT, CMS, MaskS, ShiftS));

            binaryWriter.Write(gsDPLoadSync());

            binaryWriter.Write(gsDPLoadTile(F3DEX121_OpCodes.G_TX_LOADTILE,
                (ULS << 1),
                (ULT << 2),
                (LRS << 1),
                (LRT << 2)));
            ...
            binaryWriter.Write(gsDPPipeSync());
            binaryWriter.Write(gsDPSetTile(TextureFormat, F3DEX121_Parameters.G_IM_SIZ_4b, (((((LRS) - (ULS) + 1) >> 1) + 7) >> 3), 0,
                F3DEX121_OpCodes.G_TX_RENDERTILE, PAL, CMT, MaskT, ShiftT, CMS, MaskS, ShiftS));

            binaryWriter.Write(gsDPSetTileSize(F3DEX121_OpCodes.G_TX_RENDERTILE,
                (ULS << 2),
                (ULT << 2),
                (LRS << 2),
                (LRT << 2)));
